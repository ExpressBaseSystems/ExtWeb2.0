  ...
  return (
    ...
    <div className=" dctc">
      <div className=' text-center'>
        <h1 className='dcth py-3 '>Document Management for business apps <br/>
        like never before</h1>
        <p className='dctp py-3'>A document management system that seamlessly integrates into your business process. Say goodbye to toggling between platforms—manage documents in- <br/>context,  ensuring seamless access to crucial information.</p>
        <p className="para1 ">
        Welcome to the future of efficient document handling. Our cutting-edge Document Management System (DMS) integrates all your document needs into<br/> one cohesive platform. No more juggling between different applications or losing track of crucial files.          </p>
      </div> 
